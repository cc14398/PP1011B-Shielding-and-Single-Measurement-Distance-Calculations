...
input1="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m1.root"
input2="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m2.root"
input3="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m3.root"
input4="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m4.root"
input5="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m5.root"
input6="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m6.root"
input7="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m7.root"
input8="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m8.root"
input9="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m9.root"
input10="../../../hdfs/user/cc14398/Co60-10s-28Mar/PS6m10.root"
...
print(sum(np.diff(bin_edges7)[0:16]*hist7[0:16]))
print(sum(np.diff(bin_edges8)[0:16]*hist8[0:16]))
print(sum(np.diff(bin_edges9)[0:16]*hist9[0:16]))
print(sum(np.diff(bin_edges10)[0:16]*hist10[0:16]))
